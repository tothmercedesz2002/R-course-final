...
```{r}
# According to the dataset description, there was an increase in rescues in 2020. In this section, I will confirm this trend via plotting.
...
# 🐾 Comparing the number of domestic and non-domestic animal rescues in 2020 by plotting and t-test 🐾
