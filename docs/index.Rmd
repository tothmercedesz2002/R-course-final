...
I used OpenAI’s ChatGPT throughout this project for brainstorming ideas, generating code suggestions, and debugging. I always requested explanations for the generated code and tested it to make sure that it worked correctly and aligned with my analysis goals.
