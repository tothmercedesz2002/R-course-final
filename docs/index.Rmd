...
ggplot(animal_rescues_interest, 
  aes(day_or_night_forplots, fill = day_or_night_forplots, color = "black")) +
  geom_bar() +
  labs(
    x = "Time of day",
    y = "Number of rescues",
...
```{r}
ggplot(animal_rescues_interest, 
  aes(domestic_wild_forplots, fill = domestic_wild_forplots, color = "black")) +
  geom_bar() +
  labs(
    x = "Type of animal",
    y = "Number of rescues",
...
```{r}
ggplot(animal_rescues_interest, 
  aes(borough_inner_outer_forplots, fill = borough_inner_outer_forplots, color = "black")) +
  geom_bar() +
  labs(
    x = "Type of borough",
    y = "Number of rescues",
...
# Plotting
ggplot(rescues_per_year_aggregated, aes(x = cal_year, y = rescue_count, group = 1)) +
