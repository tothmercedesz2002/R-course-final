...
ggplot(rescues_per_year, 
  aes(x = cal_year, y = rescue_count, color = domestic_wild_forplots, group = domestic_wild_forplots)) +
  geom_line(size = 1) +
  geom_point() +
  scale_x_continuous(breaks = 2009:2021) +
...
## Checking for linear relationships between incident_notional_cost and other variables via plotting
...
Due to assumption violations, I will try log-transforming the outcome variable (incident_notional_cost), and chech whether the model improves.
...
## Extracting statistics and coefficients of oomplex model, computing standardized coefficients
...
# 🐾 Comparing the simple and the more complex models' performance 🐾
